...
from ...models.machining_time_response import MachiningTimeResponse
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/plans/{plan_id}/machining-time".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = MachiningTimeResponse.from_dict(response.json())
...
def sync(
    ...
    *,
    ...
    Returns:
        MachiningTimeResponse | PipelineReadinessProblem | ProblemDetails
    """
