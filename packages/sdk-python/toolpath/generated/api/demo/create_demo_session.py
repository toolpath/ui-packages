...
def sync_detailed(
    *,
    ...
    session is isolated to its own throwaway organization, so it sees only the data it uploaded. Every
    call mints a fresh session; to keep working past the key’s expiry, call it again for a new one.
