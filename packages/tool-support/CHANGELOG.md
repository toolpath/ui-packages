...
- 744fb08: Add `@toolpath/tool-support/export/mastercam`, which writes a Mastercam
...
- 9297409: Derive a Fusion holder's `gaugeLength` from the shape that was exported, on the published arm as
