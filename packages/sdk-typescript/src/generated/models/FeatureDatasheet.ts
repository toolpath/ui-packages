...
export interface FeatureDatasheet {
  ...
  zMax: number
  /**
   * Bottom of the band a pass over the feature reaches, in mm: `zMin`, or lower where a
  ...
  extendedZMin: number
  /**
   * Top of the band a pass over the feature runs down, in mm: `zMax`, or higher where a
